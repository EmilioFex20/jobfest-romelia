  ...
  "group/button inline-flex shrink-0 items-center justify-center border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        primary:
          "bg-ink text-bone hover:bg-ember hover:text-bone hover:cursor-pointer",
        outline:
          "rounded-md border-border bg-background shadow-xs hover:bg-muted hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
        secondary:
        ...
        ghost:
          "border border-ink/20 bg-transparent text-foreground hover:border-ink hover:bg-ink hover:text-bone hover:cursor-pointer",
        destructive:
      ...
      size: {
        ...
        cta: "gap-2 px-5 py-3 rounded-xl font-medium tracking-tight",
...
function Button({
  ...
  const resolvedSize =
    size ?? (variant === "primary" || variant === "ghost" ? "cta" : "default");
